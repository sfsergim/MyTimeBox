<template>
  <div class="text-center q-pa-md">
    <div class="text-center text-grey-1 text-weight-bolder full-width bg-purple-6 q-pa-sm">
      Choose your time:
      <q-option-group
      class="row text-grey-1"
        v-model="timeChoose"
        :options="timeOptions"
        color="white"
        dark
    ...
    <div class="text-center text-lime-14 full-width bg-purple-6 q-pa-sm">
      <q-btn
        flat
        v-if="!pauseButton"
        size="15px"
...
export default {
  ...
  computed: {
    ...
    timerColor() {
      ...
      return value <= 5 ? "red-6" : value <= 10 ? "orange-6" : "lime-13";
    },
  },
  watch: {
    timeChoose() {
