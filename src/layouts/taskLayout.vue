<template>
  <q-layout view="hHh Lpr fFf">
    ...
    >
      <q-scroll-area class="fit q-pa-sm bg-grey-1">
        <!-- Content here -->
        <timer></timer>
      </q-scroll-area>
    </q-drawer>
